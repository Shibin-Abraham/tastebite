...
const Main = () => {
    ...
    const [delicious, setDelicious] = useState<meals[]>([])
    ...
    return (
        <div className="relative w-full h-auto mt-[10rem] sm:mt-[10rem] md:mt-[20rem] lg:mt-[5rem]">
            <h5 className="text-[28px] lg:text-[34px] font-playfair-display font-semibold">Super Delicious</h5>
            <div className="w-full min-h-[80rem] md:flex md:items-center md:justify-between md:flex-wrap">
                {
                    delicious.map((data, index) => {

                        return (
                            index < 9 ?
                                <div key={index} className="mt-4 w-full h-[25.5rem] md:w-[30%] md:h-[20rem] md:mr-1 group">
