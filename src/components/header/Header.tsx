        ...
        <>
            <div className="w-full h-20 flex items-center justify-between">
                ...
                <div className="h-full flex items-center">
                    ...
                    <svg onClick={() => setNav((pre) => !pre)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-12 ms-4 lg:hidden">
            ...
            <div className={`w-full h-auto transition ease-in-out duration-500  ${nav && '-translate-y-60'}`}>
